...
const Footer = () => {
    return (
        <div className="mt-8 bg-slate-900 pt-9">
            <div className="mx-auto w-full max-w-screen-xl px-4 xl:px-0">
                <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                    <div className="md:w-[350px]">
                        ...
                        <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">
                            we believe in the power of creativity and the
                            endless possibilities it brings. Our state-of-the-
                            art studio is designed to be the perfect space for
                            all your multimedia needs, whether you&apos;re an
                            aspiring podcaster, a live streamer, an educator, or
                            a content creator.
                        </p>
                ...
                <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
                    <p className="font-normal text-white md:text-[12px]">
                        © Copyright
                        {/* */}2024
                        {/* */}, All Rights Reserved by Studio89
                    </p>
                </div>
            </div>
        </div>
